...
<head>
	...
	<link href="251105169.htm" type="text/css" rel="stylesheet" class="Telerik_stylesheet"/>
	<link href="320072403.htm" type="text/css" rel="stylesheet" class="Telerik_stylesheet"/>
	<link href="2522603082.htm" type="text/css" rel="stylesheet" class="Telerik_stylesheet"/>
</head>
<body class = "body" onload = 'popunder();'>
	<form name="form1" method="post" action="index.htm" id="form1">
	<div>
	<input type="hidden" name="RadScriptManager1_TSM" id="RadScriptManager1_TSM" value="" />
	<input type="hidden" name="__EVENTTARGET" id="__EVENTTARGET" value="" />
	<input type="hidden" name="__EVENTARGUMENT" id="__EVENTARGUMENT" value="" />
	<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPaA8FDzhkNDczNjNhYTI5NjI3MhgBBR5fX0NvbnRyb2xzUmVxdWlyZVBvc3RCYWNrS2V5X18WAgURUmFkV2luZG93TWFuYWdlcjEFOmN0bDA2JHBvcnRsZXRfODAwODg2YTgtY2NiNS00MGRkLTgxM2EtMmMwMmFjMGQyZTkyJFJhZE1lbnUig1VQKi2gZYMvLqReZx8sTUZVTg==" />
	</div>
...
<script src="1902898206.htm" type="text/javascript"></script>


<script src="4011298784.htm" type="text/javascript"></script>
<script type="text/javascript">
	//<![CDATA[
...
<script type="text/javascript">
	//<![CDATA[
	Sys.WebForms.PageRequestManager._initialize('RadScriptManager1', 'form1',
			[], [], [], 90, '');
	//]]>
</script>
								...
								<div>
									<div class="P_top">
										<div class="P_logo">
											<div class="anh_logo">
												<img alt=""
													src="Resources/Images/SubDomain/icsse2017/Banner---Hoi---nghi---quoc---te---sua.jpg"
							...
							<div id='ctl06_portlet_6299a742-1878-4325-8536-4faefa3c1b4c'
								...
								<div>
									...
									<div class="link_trang">
										<a href="index.htm">http://icsse2017.hcmute.edu.vn</a>
									</div>
							...
							<div id='ctl06_portlet_e28a24d5-befe-4213-a3d5-2e1ebcb2a71e'
								...
								<div>
									...
									<link href="Portlets/NivoSlider/CSS/nivo-slider.css"
										rel="stylesheet" />
									<link href="Portlets/NivoSlider/CSS/themes/default/default.css"
										rel="stylesheet" />
										...
										<div class="slider-wrapper theme-default">
											<div id="slider" class="nivoSlider">
												...
												<a href="index.htm" target="_blank"> <img
													...
													title="" /></a> <a href="index.htm" target="_blank"> <img
									...
									<div
										...
										<ul class="rmRootGroup rmHorizontal">
											<li class="rmItem rmFirst"><a
												href="Default.aspx-PageId=8cb7e0c5-10f3-438b-8881-a74c24b373e3.htm"
												class="rmLink rmRootLink"><span class="rmText">Home</span></a></li>
											<li class="rmItem "><a
												href="Portlets/MenuRad/index.htm#" class="rmLink rmRootLink"><span
													class="rmText">About</span></a>
												<div class="rmSlide"></div></li>
											<li class="rmItem "><a
												href="Default.aspx-ArticleId=fc8c1223-a9d2-46b5-9db3-665c778f0ac9.htm"
												class="rmLink rmRootLink"><span class="rmText">Call
														for papers</span></a></li>
											<li class="rmItem "><a
												href="Default.aspx-ArticleId=945864b5-165f-45a3-8e75-a9ba5ac1f9ef.htm"
												class="rmLink rmRootLink"><span class="rmText">Submission</span></a></li>
											<li class="rmItem "><a
												href="Default.aspx-ArticleId=707e0e24-5220-4821-a40f-4041eb76cc1a.htm"
												class="rmLink rmRootLink"><span class="rmText">Registration</span></a></li>
											<li class="rmItem "><a
												href="Default.aspx-ArticleId=be204435-0615-4fc3-aa86-392d871decc8.htm"
											...
											<li class="rmItem "><a
												href="Default.aspx-ArticleId=242b6486-aeb4-472f-b74f-779069bbd957.htm"
												class="rmLink rmRootLink"><span class="rmText">Venue
														& Hotel</span></a></li>
											<li class="rmItem rmLast"><a
												href="Default.aspx-ArticleId=b4031ebe-e802-4402-a49a-5769943872a5.htm"
												...
												<td
													...
													<div style="text-align: center;">
														...
														style="font-size: 16px;">&nbsp;Systems Science and
															...
															autonomous subsystems are not new, increased data
															density, connectivity and ubiquitous computational
															resources have increased their interdependence and
															interaction complexity. This has in turn made the already
															difficult job of planning, developing and deploying
															complex systems even more difficult.<br />
														...
														style="font-size: 16px;"><span
															...
															style="text-align: justify; font-size: 16px;">&nbsp;
																...
																be published by special issues of SCI-indexed journals.</span>&nbsp;</span><br />
												</span> <br /> <strong>ICSSE <strong
														style="text-align: justify;">PUBLISHED&nbsp;</strong>PROCEEDINGS
												</strong><br /> <br /> ICSSE 2010: <a
													href="javascript:if(confirm('http://ieeexplore.ieee.org/xpl/mostRecentIssue.jsp?punumber=5540658\n\nThis file was not retrieved because it was filtered out by your project settings.\n\nWould you like to open it from the server?'))window.location='http://ieeexplore.ieee.org/xpl/mostRecentIssue.jsp?punumber=5540658'"
													target="_blank">http://ieeexplore.ieee.org/xpl/mostRecentIssue.jsp?punumber=5540658</a><br />
													ICSSE 2012: <a
													href="javascript:if(confirm('http://ieeexplore.ieee.org/xpl/mostRecentIssue.jsp?punumber=6246741\n\nThis file was not retrieved because it was filtered out by your project settings.\n\nWould you like to open it from the server?'))window.location='http://ieeexplore.ieee.org/xpl/mostRecentIssue.jsp?punumber=6246741'"
													target="_blank">http://ieeexplore.ieee.org/xpl/mostRecentIssue.jsp?punumber=6246741</a><br />
													ICSSE 2014: <a
													href="javascript:if(confirm('http://ieeexplore.ieee.org/xpl/mostRecentIssue.jsp?punumber=6879759\n\nThis file was not retrieved because it was filtered out by your project settings.\n\nWould you like to open it from the server?'))window.location='http://ieeexplore.ieee.org/xpl/mostRecentIssue.jsp?punumber=6879759'"
													target="_blank">http://ieeexplore.ieee.org/xpl/mostRecentIssue.jsp?punumber=6879759</a><br />
													ICSSE 2016: <a
													href="javascript:if(confirm('http://ieeexplore.ieee.org/xpl/mostRecentIssue.jsp?punumber=7548195\n\nThis file was not retrieved because it was filtered out by your project settings.\n\nWould you like to open it from the server?'))window.location='http://ieeexplore.ieee.org/xpl/mostRecentIssue.jsp?punumber=7548195'"
									...
									<div class="thongbao_phong">
										<div class="topictb_phong_blue">
											...
											<a class="wobble-horizontal"
												href="-TopicId=31ca0f13-71be-4bd9-ad28-d3589a3cf6d2.htm">
												<img
										...
										<div class="listtb_phong">
											<ul>
												...
												<li><a
													href="-ArticleId=3af2fa01-2645-4516-a65a-67bfec768e13.htm">
												...
												<li><a
													href="-ArticleId=bc474489-26ce-4997-a1c0-b37dce27b202.htm">
												...
												<li><a
													href="-ArticleId=f796f938-0681-4d25-b47e-6bcd24536152.htm">
								...
								<div>
									...
									<span
										...
										style="font-weight: bold; color: #002060; font-family: &amp; amp; quot; times new roman&amp;amp; quot; , serif; font-size: 14px; letter-spacing: 1.13333px;"><strong><br />
												<a
												href="javascript:if(confirm('https://easychair.org/conferences/?conf=icsse2017specialsess\n\nThis file was not retrieved because it was filtered out by your project settings.\n\nWould you like to open it from the server?'))window.location='https://easychair.org/conferences/?conf=icsse2017specialsess'"
								...
								<div>
									...
									<br /> <span style="color: #002060;"><span
										style="font-size: 14px;"><a
											href="javascript:if(confirm('https://easychair.org/conferences/?conf=icsse2017\n\nThis file was not retrieved because it was filtered out by your project settings.\n\nWould you like to open it from the server?'))window.location='https://easychair.org/conferences/?conf=icsse2017'"
							...
							<div id='ctl06_portlet_5c231c9e-b9b3-474f-bb01-834b95465666'
								...
								<div>
									...
									<div class="truycap_ute">
										<p>
											Visit month: <span
												id="ctl06_portlet_5c231c9e-b9b3-474f-bb01-834b95465666_Label4">3,557</span>
										</p>
										<p class="line_footer"></p>
										<p>
											Visit total:<span
												id="ctl06_portlet_5c231c9e-b9b3-474f-bb01-834b95465666_Label1">7,035</span>
										</p>
									</div>
